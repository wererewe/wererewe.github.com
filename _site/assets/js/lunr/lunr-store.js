var store = [{
        ...
        "teaser":null},{
        "title": "첫 포스팅",
        "excerpt":"처음 써본당!  This is an &lt;h1&gt; tag  This is an &lt;h2&gt; tag   italic italic   bold bold   You can combine them      Item 1   Item 2            Item 2a       Item 2b              Item 1   Item 2   Item 3            Item 3a       Item 3b              Blockquotes Blockquotes    Inline code   function hi() {     console.log('hi'); }   Strikethrough  ","categories": ["dev"],
        "tags": [],
        "url": "http://localhost:4000/dev/initial-post/",
        "teaser":null},{
        "title": "TypeScript - 고급 타입",
        "excerpt":"공용체(Union)  2개 이상의 타입을 조합하는 표현식. 공용체는 파이프 기호(|)를 사용한다.   ","categories": ["dev"],
        "tags": [],
